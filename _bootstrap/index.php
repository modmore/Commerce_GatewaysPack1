...
if (!createObject('modNamespace',array(
    'name' => 'commerce_gatewayspack1',
    'path' => $componentPath.'/core/components/commerce_gatewayspack1/',
    'assets_path' => $componentPath.'/assets/components/commerce_gatewayspack1/',
),'name', false)) {
    echo "Error creating namespace commerce_gatewayspack1.\n";
}

/* Path settings */
if (!createObject('modSystemSetting', array(
    'key' => 'commerce_gatewayspack1.core_path',
    'value' => $componentPath.'/core/components/commerce_gatewayspack1/',
    'xtype' => 'textfield',
    'namespace' => 'commerce_gatewayspack1',
    'area' => 'Paths',
    'editedon' => time(),
), 'key', false)) {
    echo "Error creating commerce_gatewayspack1.core_path setting.\n";
}

if (!createObject('modSystemSetting', array(
    'key' => 'commerce_gatewayspack1.assets_path',
    'value' => $componentPath.'/assets/components/commerce_gatewayspack1/',
    'xtype' => 'textfield',
    'namespace' => 'commerce_gatewayspack1',
    'area' => 'Paths',
    'editedon' => time(),
), 'key', false)) {
    echo "Error creating commerce_gatewayspack1.assets_path setting.\n";
}
...
$assetsUrl = "{$requestUri}assets/components/commerce_gatewayspack1/";

if (!createObject('modSystemSetting', array(
    'key' => 'commerce_gatewayspack1.assets_url',
    'value' => $assetsUrl,
    'xtype' => 'textfield',
    'namespace' => 'commerce_gatewayspack1',
    'area' => 'Paths',
    ...
    echo "Error creating commerce_gatewayspack1.assets_url setting.\n";
}
...
foreach ($settings as $key => $opts) {
    ...
    if (!createObject('modSystemSetting', array(
        'key' => 'commerce_gatewayspack1.' . $key,
        'value' => $opts['value'],
        'xtype' => $xtype,
        'namespace' => 'commerce_gatewayspack1',
        'area' => $opts['area'],
        ...
        echo "Error creating commerce_gatewayspack1.".$key." setting.\n";
    }
}
...
include $componentPath . '/core/components/commerce_gatewayspack1/vendor/autoload.php';

// Grab the path to our namespaced files
$modulePath = $componentPath . '/core/components/commerce_gatewayspack1/src/Modules/';

// Instruct Commerce to load modules from our directory, providing the base namespace and module path twice
$commerce->loadModulesFromDirectory($modulePath, 'modmore\\Commerce\\GatewaysPack1\\Modules\\', $modulePath);
